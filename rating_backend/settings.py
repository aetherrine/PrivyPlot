"""
Django settings for rating_backend project.
...
SECRET_KEY = 'django-insecure-z^v8@%d@)1h(ad1pcm+n_j!uw_s9wlnc-sy+(#39+l^vax3f5i'
...
ROOT_URLCONF = 'rating_backend.urls'
...
WSGI_APPLICATION = 'rating_backend.wsgi.application'
